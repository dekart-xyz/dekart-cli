...
from dekart.installation_id import CI_INSTALLATION_ID, get_installation_id
...
class InstallationIDTest(unittest.TestCase):
    ...
    def test_opt_out_skips_identity_creation_and_version_ping(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with mock.patch.dict(os.environ, env, clear=True):
                with mock.patch("dekart.cli.urllib.request.urlopen") as urlopen:
    ...
    def test_version_ping_sends_installation_id(self):
        ...
        with mock.patch("dekart.cli.get_installation_id", return_value=installation_id):
            with mock.patch("dekart.cli.urllib.request.urlopen") as urlopen:
                cli.send_version_ping()
